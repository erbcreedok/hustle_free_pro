      ...
      >
        <ImageWrapper>
          ...
          >
            <ProductText
              ...
              color={'#272727'}
              margin={'0 0 14px 0'}
            >Кимоно для тхэквондо</ProductText>
            <ProductText
              fontWeight={700}
              fontSize={'12px'}
              lineheight={'14px'}
        ...
        >
          ...
          <ProductText
            ...
            margin={'0'}
          >
            Arcu hendrerit iaculis himenaeos senectus orci justo, tristique hac conubia erat libero. Ornare dapibus tellus finibus ullamcorper vehicula dis parturient, suscipit praesent aliquam lacinia donec condimentum luctus, imperdiet auctor facilisi enim odio risus.
          </ProductText>
        </DescriptionWrapper>
